#pragma once
#ifndef POLYPLUCK_D_H
#define POLYPLUCK_D_H
...
adding some extra functions for finer control of the available parameters

**Changes**
added set damp

**Author**: shensley
**Modified by**: daniel lawler
...
class PolyPluck_p
{
  public:
    ...
    */
    void SetDecay(float p) { p_decay_ = p; }
    void SetDamp(float p)  {p_damp_ = p; }
